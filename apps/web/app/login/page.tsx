  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-background p-4">
      <AuthForm
        ...
        description="Sign in to access your living layer."
        primaryAction={{
          label: "Continue with Google",
          icon: <IconGoogle className="mr-2 h-4 w-4" />,
          onClick: () => void signInWith(googleProvider),
        }}
        secondaryActions={[
          {
          ...
          },
          {
            ...
            onClick: () => void signInWith(githubProvider),
          },
        ]}
        skipAction={{
          label: "Skip for now",
